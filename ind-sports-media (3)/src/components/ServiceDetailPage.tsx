...
export default function ServiceDetailPage({ serviceId, onBack, onBookNow }: ServiceDetailProps) {
  ...
  const content = {
    'game-coverage': {
      ...
      description1: 'Get professional, multi-camera varsity game film. We deploy broadcast-grade 4K equipment to cover your matchups, creating high-definition files ideal for coaching analysis, team study, and high-octane season recaps.',
      description2: 'Your plays on the field deserve to be documented in full clarity. We work directly with high school athletic coordinators, booster clubs, and coaches to integrate our film seamlessly with digital video platforms like Hudl.',
      ...
      packages: [
        ...
        },
        {
          ...
          features: [
            ...
            '1 Complimentary 5-minute team season trailer'
          ],
          popular: false
        }
      ],
      stats: [
        ...
        { label: 'Digital Video Views', value: '85k+' }
      ]
    },
    'girls-flag-football': {
      ...
      description2: 'Through slow-motion cinematic focus, high-impact highlights, and spotlight tracking overlays, we give athletes the spotlight they deserve. Showcase your athletic skills and speed through ready-to-share digital portfolios.',
      ...
      features: [
        ...
        },
        {
          ...
          desc: 'Engineered with professional broadcast precision to highlight technical footwork, route running, and timing.',
          icon: <Award className="w-6 h-6 text-red-500" />
        },
        {
      ...
      packages: [
        {
          ...
          features: [
            ...
            'Digital athlete portfolio card embed'
          ],
          popular: false
        },
        {
        ...
        },
        {
          ...
          features: [
            ...
            'Individual spotlight highlight reels created',
            'Shared highlights compilation',
            'Full 4K digital master & social export bundle'
          ],
          popular: false
        }
      ],
      stats: [
        ...
        { label: 'State Tournaments Covered', value: '35+' },
    ...
    <div className="min-h-screen bg-black text-white selection:bg-red-600 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <p className="mt-2 text-neutral-500 font-display text-sm tracking-widest uppercase">
              How we construct broadcast-grade film that captures every defining moment.
            </p>
          </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          ...
          <p className="mt-2 text-neutral-500 font-display text-sm tracking-widest uppercase">
            Select the optimal coverage package for your season media goals.
          </p>
        </div>
