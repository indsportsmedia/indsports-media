    ...
    <div className="pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        ...
        <p className="text-white/60 font-sans text-base leading-relaxed">
          High-definition sideline coverage captured by IND Sports Media's accredited field photographers. Download, share, or request high-resolution photo galleries for digital portfolios, team yearbooks, and social channels.
        </p>
      </div>
