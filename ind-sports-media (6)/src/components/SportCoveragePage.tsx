...
const SPORT_DATA = {
  Football: {
    ...
    description: '4K sideline cinematography, mic’d up athlete features, varsity showcase reels, and complete game film packages.',
    ...
    stats: [
      ...
      { label: 'All-State Athletes Covered', value: '85+' },
      { label: 'Highlight Views', value: '12.4M' }
    ],
    features: [
      'Multi-angle 4K Endzone & Sideline Video',
      'Custom Cinematic Highlight Mixes with Verified Timestamps',
  ...
  Basketball: {
    ...
    description: 'Floor-level slow-motion mixtape edits, posterizing dunk reels, clutch game-winner highlights, and digital showcase packages.',
    ...
    features: [
      ...
      'Player Spotlight & Performance Dossiers',
      'Custom Multi-Platform Social Content Suites'
    ]
  },
  Volleyball: {
    tagline: 'Explosive Spikes, Libero Digs & Championship Rallies',
    description: 'Precision net-side tracking, multi-angle spike reels, and comprehensive performance packages for indoor and beach athletes.',
    ...
    stats: [
      ...
      { label: 'State Tournaments Filmed', value: '60+' },
    ...
    features: [
      ...
      'High-Performance Highlight Reels & Media Portfolios'
    ]
  },
  Wrestling: {
    ...
    features: [
      ...
      'High School All-State & All-American Feature Profiles'
    ]
  },
  'Flag Football': {
    ...
    features: [
      ...
      'USA Flag Football Performance & Media Spotlights',
