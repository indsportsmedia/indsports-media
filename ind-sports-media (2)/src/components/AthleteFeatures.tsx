...
const ATHLETES_DATA: AthleteProfile[] = [
  {
    ...
    status: '5-Star Recruit • State MVP Candidate',
    stats: [
    ...
    scoutSummary: 'Elite separation speed with NFL-caliber route tree discipline. Breaks tackles in space and possesses unbelievable hand-eye coordination under double coverage.',
    ...
    offers: ['Alabama', 'Ohio State', 'USC', 'Georgia', 'Texas']
  },
  {
    id: 'a2',
    name: 'Amari Vance',
    ...
    status: 'McDonald’s All-American Watchlist',
    stats: [
    ...
    offers: ['Kentucky', 'Duke', 'Kansas', 'UCLA', 'Arizona']
  },
  {
    id: 'a3',
    ...
    offers: ['Stanford', 'Texas', 'Nebraska', 'Wisconsin', 'Penn State']
  },
  {
    id: 'a4',
    ...
    offers: ['Penn State', 'Iowa', 'Oklahoma State', 'Cornell', 'Michigan']
  },
  {
    id: 'a5',
    name: 'Kayla Reynolds',
    ...
    offers: ['Florida Gators Flag', 'Ottawa University', 'Keiser', 'Thomas More']
  }
];
    ...
    <div className="pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="text-center max-w-3xl mx-auto mb-14">
        ...
        <p className="text-white/60 font-sans text-base leading-relaxed">
          In-depth profiles, recruitment updates, and verified scouting dossiers of high school and youth athletes making national waves.
        </p>
      </div>
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-between">
            <div>
              ...
              <div className="bg-white/5 border-l-2 border-[#00BFFF] p-4 rounded-r mb-6">
                <div className="text-xs uppercase font-black text-white/50 mb-1">IND Scout Analysis</div>
              ...
              <div>
                <div className="text-xs uppercase font-black text-white/40 mb-2">Notable College Offers & Interests</div>
